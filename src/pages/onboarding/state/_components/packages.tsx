...
export default function Packages() {
  return (
    <div className="mt-10">
      ...
      <div className="mt-10 flex items-stretch gap-5 rounded-2xl border-2 border-[#E5EBF2] p-6">
        {plans.map((plan) => (
          <div
            key={plan.id}
            className={cn(
          ...
          >
            ...
            <Button
              className={cn(
                "h-10 w-full rounded-xl border border-black bg-transparent text-sm font-semibold text-black",
                {
